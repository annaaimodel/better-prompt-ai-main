...
<meta property="og:type" content="website"><meta property="og:site_name" content="AURUM"><meta property="og:title" content="AURUM · High-Ticket Sales Communities"><meta property="og:description" content="A curated directory of the best Facebook, Skool, Discord & LinkedIn communities hiring high-ticket sales talent."><meta property="og:url" content="https://aurum-hts.vercel.app/directory"><meta property="og:image" content="https://aurum-hts.vercel.app/og-image.png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:image" content="https://aurum-hts.vercel.app/og-image.png">
<style>
...
function render(){
  ...
  for(const s of DATA){
    ...
    if(secHtml){
      ...
      sec.innerHTML=`<div class="phead">${esc(s.title)}</div>`+secHtml;
      res.appendChild(sec);
    }
  }
